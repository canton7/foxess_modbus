...
if test -f /config/www/foxess-modbus-time-period-card.js; then
  rm /config/www/foxess-modbus-time-period-card.js
fi
if test -f "$(workspacePath)foxess-modbus-time-period-card/foxess-modbus-time-period-card.js"; then
  mkdir -p /config/www
  ln -sf "$(workspacePath)foxess-modbus-time-period-card/foxess-modbus-time-period-card.js" /config/www
fi
